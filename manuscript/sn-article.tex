...
\abstract{
    ...
    The cell growth phase was conducted in a L-scale bioreactor.
    ...
    With the proposed setup, 192 protein expression conditions were studied during four experimental runs with minimal manual workload, showing the reliability and potential of the mL-scale bioreactors.
}
