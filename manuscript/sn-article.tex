...
\abstract{
    ...
    After the desired cell density for protein expression was reached, the cells were automatically transferred to 48 mL-scale bioreactors operated by an liquid handling station where protein expression studies were started where the feed rate and the inductor concentration was varied. 
    At the end of protein production, the enzymatic activity was estimated by performing automated whole-cell biotransformations in a deep-well-plate. The results were modelled with bayesian modelling to account for the biomass growth
    ...
    At the optimal investigated expression conditions an activity of $1153\ U\ mL^{-1}$ was estimated with a $90\ \%$ credible interval of $[992, 1321]\ U\ mL^{-1}$. This is about 40-fold higher than the highest published data for the enzyme under study.
