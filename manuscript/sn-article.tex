...
\abstract{
    ...
    The results were modelled with Bayesian modelling to account for the biomass growth during the biotransformations and predict absolute and specific enzyme activities as well as optimal expression conditions.
