...
\abstract{
    ...
    However, their application is often limited to products with very non-complex analytics.
    ...
    During protein expression, the feed rate and the inductor concentration was varied.
...
The calibration at 360 nm is required to counteract potential interference with the product determination at the same wavelength.
...
\begin{figure}[H]
    ...
    \caption{
        ...
        The gray ares depict the experimentally relevant ranges.
    }
    \label{fig_cmXA600}
\end{figure}
